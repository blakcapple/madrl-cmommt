...
def get_pursuer_start_point(num, env_config:BaseConfig):
...
def get_evader_start_point(num, env_config:BaseConfig):
    '''
...
def init_agent(env_config:BaseConfig, pursuer_num, evader_num, render=False) -> Tuple[List[Agent], List[Agent]]: 
    ...
    evader_policie_name = env_config.evader_policy
